        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedidos_Socios_SocioId",
                        column: x => x.SocioId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TorneosSocios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TorneosSocios_Socios_IdSocio",
                        column: x => x.IdSocio,
                        principalTable: "Socios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_TorneosSocios_Torneos_IdTorneo",
                        column: x => x.IdTorneo,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagoPedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PagoPedido_Pagos_IdPago",
                        column: x => x.IdPago,
                        principalTable: "Pagos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PagoPedido_Pedidos_IdPedido",
                        column: x => x.IdPedido,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagoPedido_IdPago",
                table: "PagoPedido",
                column: "IdPago");

            migrationBuilder.CreateIndex(
                name: "IX_PagoPedido_IdPedido",
                table: "PagoPedido",
                column: "IdPedido");

            migrationBuilder.CreateIndex(
                name: "IX_Pedidos_SocioId",
                table: "Pedidos",
                column: "SocioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TorneosSocios_IdSocio",
                table: "TorneosSocios",
                column: "IdSocio");

            migrationBuilder.CreateIndex(
                name: "IX_TorneosSocios_IdTorneo",
                table: "TorneosSocios",
                column: "IdTorneo");
        }
